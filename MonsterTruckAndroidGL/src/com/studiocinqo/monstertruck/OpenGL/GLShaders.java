...
public class GLShaders {
     ...
     * SHADER Image
     * 
     * This shader is for rendering 2D images straight from a texture No
     * additional effects.
     * 
     */
    ...
    public static final String fs_Image = "precision mediump float;"
	    ...
	    + "uniform float f_offset;" + "void main() {"
	    + "  gl_FragColor = texture2D( s_texture, vec2(v_texCoord.x + f_offset, v_texCoord.y ));"
	    + "}";
