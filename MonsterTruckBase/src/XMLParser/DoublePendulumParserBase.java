...
public abstract class DoublePendulumParserBase<T> implements IObjectParser<IWorldDynamicObject<T>> {
	...
	public void sealElement() {
		sealed = true;
		System.err.format("DoublePendulum: [%f %f], %f  %n", center.X, center.Y, radius);
	}
